...
const VideoUpload = () => {
    ...
    const  uploadImage = async (e,type)=> {
        ...
        try {
            const response = await axios.post(`https://api.cloudinary.com/v1_1/dkyamwvho/${type}/upload`,data);
        ...
        <div className='videoUpload'>
            <div className="uploadBox">
                ...
                <div className="uploadForm">
                    ...
                    <div>
                        Thumbnail <input type="file" onChange={(e)=>uploadImage(e,"image")} accept="image/*"/>
                    </div>
                    <div>
                        Video <input type="file" onChange={(e)=>uploadImage(e,"video")} accept="video/mp4, video/webm, video/*"/>
                    </div>
